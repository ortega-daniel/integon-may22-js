        ...
        <ul id="sidebarnav">
          <li class="user-profile">
            <a
              ...
              href="#"
              aria-expanded="false"
              ><img src="/assets/images/users/profile.png" alt="user" /><span
                class="hide-menu"
                >Steave Jobs
              </span></a
            >
          ...
          <li>
            ...
            <ul aria-expanded="false" class="collapse">
              ...
              <li><router-link to="/grafica1">Grafica 1</router-link></li>
          ...
          <li>
            <a
              ...
              ><span class="hide-menu">Page Layout</span></a
            >
            <ul aria-expanded="false" class="collapse">
            ...
            <ul aria-expanded="false" class="collapse">
              ...
              <li>
                <a href="#" class="has-arrow"
                  >Authentication
                  <span class="label label-rounded label-success pull-right"
                    >6</span
                  ></a
                >
                <ul aria-expanded="false" class="collapse">
